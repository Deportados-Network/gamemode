    ...
    if not carry.InProgress then
        ...
        if closestPlayer then
            ...
            if targetSrc ~= -1 then
                ...
                carry.type = "carrying"
                exports['depo_notify']:Alert("NOTIFICACION", "Cargaste a una persona", 5000, 'general')
            else
                exports['depo_notify']:Alert("ERROR", "No hay nadie cerca para cargar", 5000, 'error')
            end
        else
            exports['depo_notify']:Alert("ERROR", "No hay nadie cerca para cargar", 5000, 'error')
        end
        ...
        carry.targetSrc = 0
        exports['depo_notify']:Alert("NOTIFICACION", "Dejaste de cargar a la persona", 5000, 'general')
    end
end, false)
