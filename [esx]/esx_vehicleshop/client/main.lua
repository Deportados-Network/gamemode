...
RegisterNetEvent('esx_vehicleshop:actualizarCoches', function(vehicles, categories, vehiclesByModel)
	Vehicles = vehicles
	...
	print(('^2[esx_vehicleshop]^7 Loaded ^5%d^7 vehicles!'):format(#Vehicles))
end)
				...
				ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'set_vehicle_owner_sell_amount', {
					...
					if amount == nil then
						...
						if closestPlayer == -1 or closestDistance > 3.0 then
							...
							exports['bm_security']:call('esx_billing:sendBill', true, GetPlayerServerId(closestPlayer), 'society_cardealer', TranslateCap('car_dealer'), tonumber(data2.value))
						end
					end
				end, function(data2, menu2)
					menu2.close()
