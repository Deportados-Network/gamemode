...
function SQLVehiclesAndCategories()
	...
	print(('[^2INFO^7] ^5%s^7 vehicles loaded!'):format(#vehicles))
	TriggerClientEvent("esx_vehicleshop:actualizarCoches", -1, vehicles, categories, vehiclesByModel)
end
...
RegisterNetEvent("esx_vehicleshop:getVehiclesAndCategories", function()
	TriggerClientEvent("esx_vehicleshop:actualizarCoches", source, vehicles, categories, vehiclesByModel)
end)
