  ...
  while true do
    ...
    for k,v in pairs(Config.Zones) do
      if(v.Type ~= -1 and #(coords - vec3(v.Pos.x, v.Pos.y, v.Pos.z)) < Config.DrawDistance) then
        msec = 0
        DrawMarker(v.Type, v.Pos.x, v.Pos.y, v.Pos.z, 1, 1, 1, 1, 1, 1, v.Size.x, v.Size.y, v.Size.z, v.Color.r, v.Color.g, v.Color.b, 255, false, true, 5, false, false, false, false)
      end
    end
    Wait(msec)
  end
