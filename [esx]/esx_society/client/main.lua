	...
	ESX.TriggerServerCallback('esx_society:isBoss', function(isBoss)
		if isBoss then
			...
			if options.checkBal then
				elements[#elements+1] = {icon = "fas fa-wallet", title = "Comprobar dinero de la empresa", value = "check_society_balance"}
			end
			...
			if options.grades then
				elements[#elements+1] = {icon = "fas fa-scroll", title = "Rangos", value = "manage_grades"}
			end
			...
			ESX.OpenContext("right", elements, function(menu,element)
				...
				elseif element.value == "withdraw_society_money" then
					local elements = {
						{unselectable = true, icon = "fas fa-wallet", title = TranslateCap('withdraw_amount'), description = "Retirar dinero de la empresa"},
						{icon = "fas fa-wallet", title = "Amount", input = true, inputType = "number", inputPlaceholder = "Cantidad para retirar..", inputMin = 1, inputMax = 250000, name = "withdraw"},
						{icon = "fas fa-check", title = "Confirmar", value = "confirm"},
						{icon = "fas fa-arrow-left", title = "Volver", value = "return"}
					}
				...
				elseif element.value == "deposit_money" then
					local elements = {
						{unselectable = true, icon = "fas fa-wallet", title = TranslateCap('deposit_amount'), description = "Depositar dinero en la empresa"},
						{icon = "fas fa-wallet", title = "Cantidad", input = true, inputType = "number", inputPlaceholder = "Amount to deposit..", inputMin = 1, inputMax = 250000, name = "deposit"},
						{icon = "fas fa-check", title = "Confirmar", value = "confirm2"},
						{icon = "fas fa-arrow-left", title = "Volver", value = "return"}
					}
					ESX.RefreshContext(elements)
				...
				elseif element.value == "wash_money" then
					local elements = {
						{unselectable = true, icon = "fas fa-wallet", title = TranslateCap('wash_money_amount'), description = "Lavar dinero"},
						{icon = "fas fa-wallet", title = "Amount", input = true, inputType = "number", inputPlaceholder = "Cantidad a lavar..", inputMin = 1, inputMax = 250000, name = "wash"},
						{icon = "fas fa-check", title = "Confirmar", value = "confirm3"},
						{icon = "fas fa-arrow-left", title = "Volver", value = "return"}
					}
					ESX.RefreshContext(elements)
...
function OpenManageEmployeesMenu(society, options)
	...
	elements[#elements+1] = {icon = "fas fa-arrow-left", title = "Volver", value = "return"}
...
function OpenEmployeeList(society, options)
	ESX.TriggerServerCallback('esx_society:getEmployees', function(employees)
		local elements = {
			{unselectable = true, icon = "fas fa-user", title = "Empleados"}
		}
		...
		ESX.OpenContext("right", elements, function(menu,element) 
			if element.value == "return" then
				...
				local elements2 = {
					...
					{icon = "fas fa-user", title = "Ascender", value = "promote"},
					{icon = "fas fa-user", title = "Despedir", value = "fire"},
					{icon = "fas fa-arrow-left", title = "Volver", value = "return"}
				}
...
function OpenManageSalaryMenu(society, options)
	ESX.TriggerServerCallback('esx_society:getJob', function(job)
		...
		ESX.OpenContext("right", elements, function(menu,element)
			local elements = {
				{unselectable = true, icon = "fas fa-wallet", title = element.title, description = "Cambiar cantidad de salarios", value = element.value},
				{icon = "fas fa-wallet", title = "Cantidad", input = true, inputType = "number", inputPlaceholder = "Cantidad..", inputMin = 1, inputMax = Config.MaxSalary, name = "gradesalary"},
				{icon = "fas fa-check", title = "Confirmar", value = "confirm"}
			}
...
function OpenManageGradesMenu(society, options)
	ESX.TriggerServerCallback('esx_society:getJob', function(job)
		...
		ESX.OpenContext("right", elements, function(menu,element)
			local elements = {
				{unselectable = true, icon = "fas fa-wallet", title = element.title, description = "Cambiar nombre del grado", value = element.value},
				{icon = "fas fa-wallet", title = "Label", input = true, inputType = "text", inputPlaceholder = "Nombre..", name = "gradelabel"},
				{icon = "fas fa-check", title = "Confirmar", value = "confirm"}
			}
