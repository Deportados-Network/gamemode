...
Locales['es'] = {
  ...
  -- Death
  ['respawn_available_in'] = 'Estas ~r~muerto~s~. Podras reaparecer en ~y~%s ~w~minutos ~y~%s ~w~segundos',
  ['respawn_bleedout_in'] = 'te desangrarás en ~y~%s ~w~minutos ~y~%s ~w~segundos\n',
  ['respawn_bleedout_prompt'] = 'Mantén ~y~[E] ~g~reaparecer',
  ['respawn_bleedout_fine'] = 'Mantén [E] para reaparecer  ~b~$%s',
  ['respawn_bleedout_fine_msg'] = 'Tu pagaste $%s para reaparecer.',
  ['distress_send'] = 'Presiona ~b~[G] ~w~para enviar señal de socorro',
