...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('gna',0,'aspirant','Aspirant',0,'{}','{}'),
	('gna',1,'surveillant','Surveillant',0,'{}','{}'),
	('gna',2,'agent','Agent',0,'{}','{}'),
	('gna',3,'hoofdagent','Hoofdagent',0,'{}','{}'),
	('gna',4,'brigadier','Brigadier',0,'{}','{}'),
  ('gna',5,'inspecteur','Inspecteur',0,'{}','{}'),
  ('gna',6,'hoofdinspecteur','Hoofdinspecteur',0,'{}','{}'),
  ('gna',7,'commissaris','Commissaris',0,'{}','{}'),
  ('gna',8,'hoofdcommissaris','Hoofdcommissaris',0,'{}','{}'),
	('gna',9,'boss','Eerste Hoofdcommissaris',0,'{}','{}')
;
