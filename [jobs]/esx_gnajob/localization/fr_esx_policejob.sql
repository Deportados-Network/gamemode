...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('gna',0,'recruit','Recrue',20,'{}','{}'),
	('gna',1,'officer','Officier',40,'{}','{}'),
	('gna',2,'sergeant','Sergent',60,'{}','{}'),
	('gna',3,'lieutenant','Lieutenant',85,'{}','{}'),
	('gna',4,'boss','Chef',100,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	("Irrespect envers un agent de gna", 110, 1),
	("Menace verbale envers un civil", 90, 1),
	("Menace verbale envers un agent de gna", 150, 1),
	...
	("Enlèvement d'un agent de gna", 2000, 2),
	...
	("Agression sur un agent de gna", 2500, 3),
	("Tentative de meurtre sur un civil", 3000, 3),
	("Tentative de meurtre sur un agent de gna", 5000, 3),
	("Meurtre d'un civil", 10000, 3),
	("Meurtre d'un agent de gna", 30000, 3),
