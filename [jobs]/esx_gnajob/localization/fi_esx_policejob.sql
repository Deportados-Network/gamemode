...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('gna',0,'recruit','Tulokas',20,'{}','{}'),
	('gna',1,'officer','Konstaapeli',40,'{}','{}'),
	('gna',2,'sergeant','Ylikonstaapeli',60,'{}','{}'),
	('gna',3,'lieutenant','Kersantti',85,'{}','{}'),
	('gna',4,'boss','Komentaja',100,'{}','{}')
;
