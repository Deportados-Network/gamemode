...
Config.Strings = {
	ExitVehicle = "Sal del vehículo para rellenar gasolina",
	EToRefuel = "Pulsa ~g~E ~w~para rellenar gasolina",
	JerryCanEmpty = "Bidón de gasolina vacío",
	...
	RefillJerryCan = "Pulsa ~g~E ~w~ para rellenar gasolina por ",
