...
Config.Blips = {
    ...
    ['air'] = {
        Garage = {
            Name = 'Garaje de helicopteros',
            Type = 357,
            Size = 0.5,
            Color = 17
        },
        Impound = {
            Name = 'Incautados de helicopteros',
            Type = 357,
            Size = 0.5,
            Color = 3
        },
...
Config.Garages = {
    {
        ...
        Visible = true, --Blip visible on map.
        Type = 'car',
        Position = vector3(1723.0000, 3716.3157, 34.1603),
        SpawnPosition = vector4(1723.0000, 3716.3157, 34.1603, 28.8587) --vector4(x, y, z, heading)
    },
    {
        Visible = true, --Blip visible on map.
        Type = 'car',
        Position = vector3(-349.0308, -874.7482, 31.3180),
        SpawnPosition = vector4(-337.8649, -889.9247, 31.0715, 349.1085) --vector4(x, y, z, heading)
    },
    {
        Visible = true, --Blip visible on map.
        Type = 'car',
    ...
    {
        Visible = false, --leandro garaje en meca
        Type = 'air',
        Position = vector3(-237.164825, -1327.041748, 48.404419),
        SpawnPosition = vector4(-237.164825, -1327.041748, 48.404419, 87.874016) --vector4(x, y, z, heading)
    },
    {
        Visible = true, --Blip visible on map.
        Type = 'boat',
    ...
    },
    {
        Visible = true, --Blip visible on map.
        Type = 'car',
        Position = vector3(889.64, -72.88, 78.76),
        SpawnPosition = vector4(889.64, -72.88, 78.76, 150.69) --vector4(x, y, z, heading)
    },
