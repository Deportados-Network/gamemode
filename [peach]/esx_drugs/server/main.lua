...
-- CAMIONETA MARIHUANA
RegisterServerEvent('esx_inventoryhud:removeItem')
AddEventHandler('esx_inventoryhud:removeItem', function(itemName, amount)
...
RegisterServerEvent('esx_blackmoney:give')
AddEventHandler('esx_blackmoney:give', function(amount)
    local xPlayer = ESX.GetPlayerFromId(source)
