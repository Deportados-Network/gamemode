function storePlayerClothes()
    ...
    playerClothes = {
        ...
        feet = GetPedDrawableVariation(player, 34),
        feet_texture = GetPedTextureVariation(player, 0),
...
function restorePlayerClothes()
    ...
    SetPedComponentVariation(player, 6, playerClothes["feet"], playerClothes["feet_texture"], 34)
...
function changeClothes(torso,pant,shoes,shirt,arms)
    ...
    SetPedComponentVariation(player, 6, shoes[1], shoes[2], 34)
