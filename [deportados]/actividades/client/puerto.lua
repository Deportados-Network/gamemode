...
function mechStart(inicoords, carcoords, vehicle, carh)
    ...
    TriggerServerEvent("InteractSound_SV:PlayWithuniversalinDistance", 10, "MisionPuerto1", 1.5)
    Citizen.Wait(2000)
...
function finishJob(mechveh)
    ...
    TriggerServerEvent("InteractSound_SV:PlayWithuniversalinDistance", 10, "MisionPuerto4", 1.5)
...
function CreateMechBlipMerc()
    ...
    TriggerServerEvent("InteractSound_SV:PlayWithuniversalinDistance", 10, "MisionPuerto2", 1.5)
end

RegisterCommand("terminarpuerto", function()
    RemoveBlip(mechblip)
    RemoveBlip(mercblip)
    point = false
    ESX.ShowNotification('Actividad cancelada')
    TriggerServerEvent("InteractSound_SV:PlayWithuniversalinDistance", 10, "MisionPuerto3", 1.5)
    start()
end)
